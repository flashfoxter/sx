...
init_help_array(void)
{
  ...
  modify_args_info_help[12] = modify_args_info_full_help[12];
  modify_args_info_help[13] = modify_args_info_full_help[15];
  modify_args_info_help[14] = 0; 
  
}

const char *modify_args_info_help[15];
...
void init_args_info(struct modify_args_info *args_info)
{
  ...
  args_info->name_help = modify_args_info_full_help[8] ;
  args_info->reset_custom_meta_help = modify_args_info_full_help[9] ;
  args_info->reset_local_config_help = modify_args_info_full_help[11] ;
  args_info->debug_help = modify_args_info_full_help[12] ;
  args_info->config_dir_help = modify_args_info_full_help[13] ;
  args_info->filter_dir_help = modify_args_info_full_help[14] ;
  args_info->batch_mode_help = modify_args_info_full_help[15] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVr:o:s:m:n:Dc:b", long_options, &option_index);
